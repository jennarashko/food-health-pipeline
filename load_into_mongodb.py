...
USDA_COLLECTIONS = {
    "survey": {
        "bucket": "survey-foods-food-health-pipeline",
        "blob_prefix": "survey_all",
        "collection": "survey-food-data-collection",
    },
    "legacy": {
        "bucket": "legacy-foods-food-health-pipeline",
        "blob_prefix": "legacy_all",
        "collection": "legacy-food-data-collection",
    },
    "foundation": {
        "bucket": "foundation-foods-food-health-pipeline",
...
if __name__ == "__main__":
    ...
    for key in USDA_COLLECTIONS:
        ...
        count = load_dataset_gcs_to_mongo(key, date_str="2026-03-16")
